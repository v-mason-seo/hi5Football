...
public class CountryFlagUtils {
    ...
    static CountryFlagUtils instance;

    public static CountryFlagUtils getInstance() {

        if ( instance == null ) {
            instance = new CountryFlagUtils();
        }
    ...
    public int getResId(String country, Context context) {
        ...
        String name = "flag_" + countryCode.toLowerCase();
