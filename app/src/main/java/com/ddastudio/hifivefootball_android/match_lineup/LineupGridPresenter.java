...
public class LineupGridPresenter implements BaseContract.Presenter {

    MatchModel mMatch;
    LineupGridFragment mView;
    ...
    public LineupGridPresenter(MatchModel match) {
    ...
    public void attachView(BaseContract.View view) {
        this.mView = (LineupGridFragment)view;
