...
/**
 * Created by hongmac on 2018. 1. 30..
 */

public class GridLineDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridLineDividerDecoration(Context context) {
