...
public class ItemListRvAdapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
    /**
     ...
     */
    public ItemListRvAdapter(List<MultiItemEntity> data) {
        super(data);
    ...
    protected void convert(BaseViewHolder helper, MultiItemEntity item) {
        ...
        UserModel userData = (UserModel)item;

        helper.setText(R.id.user_name, userData.getNickNameAndUserName())
                .setText(R.id.user_profile, userData.getProfile())
                .setGone(R.id.user_profile, !TextUtils.isEmpty(userData.getProfile()))
        ;
