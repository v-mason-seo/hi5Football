package com.ddastudio.hifivefootball_android.ui.adapter;
...
/**
 * Created by hongmac on 2017. 9. 27..
 */

public class ItemDragAndSwipeCallback2 extends ItemTouchHelper.Callback {
    ...
    public ItemDragAndSwipeCallback2(BaseItemDraggableAdapter adapter) {
        mAdapter = adapter;
    }
    ...
    public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getTag(com.chad.library.R.id.BaseQuickAdapter_dragging_support) != null
                && (Boolean) viewHolder.itemView.getTag(com.chad.library.R.id.BaseQuickAdapter_dragging_support)) {
        ...
        if (viewHolder.itemView.getTag(com.chad.library.R.id.BaseQuickAdapter_swiping_support) != null
                && (Boolean) viewHolder.itemView.getTag(com.chad.library.R.id.BaseQuickAdapter_swiping_support)) {
    ...
    public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder source, RecyclerView.ViewHolder target) {
        ...
        return ( source instanceof BaseViewHolder) && ( target instanceof BaseViewHolder);
