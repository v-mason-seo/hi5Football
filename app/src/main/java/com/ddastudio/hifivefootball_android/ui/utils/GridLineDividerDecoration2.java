...
/**
 * Created by hongmac on 2018. 2. 2..
 */

public class GridLineDividerDecoration2 extends RecyclerView.ItemDecoration {
    ...
    public GridLineDividerDecoration2(Context context) {
        TypedArray a = context.obtainStyledAttributes(ATTRS);
        mDivider = a.getDrawable(0);
        a.recycle();

        mInsets = context.getResources().getDimensionPixelSize(R.dimen.card_insets2);
        //mInsets = 0;
    }
