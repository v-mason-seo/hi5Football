...
//    static RoundRectHelper sRoundRectHelper;
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            if (viewType == ViewType.MATCH_SECTION_HEADER
                    || viewType == ViewType.MAIN_MATCH_SECTION
                    || viewType == ViewType.SIMPLE_SECTION_HEADER) {
                ...
                int currentViewType = parent.getAdapter().getItemViewType(position + 1);
                if (currentViewType == ViewType.MATCH_SECTION_HEADER
                        || currentViewType == ViewType.MAIN_MATCH_SECTION
                        || currentViewType == ViewType.SIMPLE_SECTION_HEADER) {
